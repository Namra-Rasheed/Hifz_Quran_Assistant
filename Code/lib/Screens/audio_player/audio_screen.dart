  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Surah',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800),),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Container(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'عدد الآيات : ${widget.list![currentIndex].numberOfAyahs}',
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Display the Previous Surah section only if currentIndex > 0
                        if (currentIndex > 0) ...[
                          Text(
                            'PREVIOUS SURAH',
                            style: TextStyle(
                        ...
                        SizedBox(height: 12),
                        // Display the Upcoming Surah
                        Visibility(
                          visible: (currentIndex + 1 <= 113), // Ensure index stays in bounds
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Icon(Icons.play_circle_fill, color: Colors.green),
